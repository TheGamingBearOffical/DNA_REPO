  ...
  return (
    <div className="bg-light text-dark min-vh-100 p-5" style={{ fontFamily: 'Poppins, Segoe UI, Roboto, sans-serif' }}>
      ...
      <div className="mb-4">
        ...
        <input id="dna-upload" type="file" accept=".txt,.csv,.json" className="form-control bg-white text-dark border-primary mt-2" />
      </div>
        ...
        <div className="col-md-6">
          <div className="card shadow-sm border-primary">
            <div className="card-body">
              ...
              <label htmlFor="food-facts" className="form-label">Facts about food:</label>
              <input id="food-facts" type="text" className="form-control border-primary mb-3" placeholder="Enter food facts manually..." />
